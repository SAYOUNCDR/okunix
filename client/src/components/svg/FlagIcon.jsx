...
/**
 * Renders SVG country flags based on the country name.
 * Uses NucleoApp SVG paths for consistency.
 */
const FlagIcon = ({ countryName, className = "w-6 h-6" }) => {
  const name = (countryName || "").toLowerCase();

  // Helper mapping dictionary connecting country names to SVG elements
  const flagMap = {
    india: (
      <svg
    ...
    "united kingdom": (
      ...
      >
        ...
        ></rect>
        <path
          d="M30.362,4H1.638c-.244,0-.472,.071-.664,.182l12.783,8.522h4.485L31.026,4.182c-.192-.112-.42-.182-.664-.182Z"
          fill="#102d5e"
        ></path>
        <path d="M12.203,14,1,6.598v6.402H6.903l5.3-3Z" fill="#a62842"></path>
        <path
          d="M31.026,27.818c.192-.112,.42-.182,.664-.182H1.638c.244,0,.472,.071,.664,.182l12.783-8.522h4.485l12.783,8.522Z"
          fill="#102d5e"
        ></path>
        <path
          d="M31,25.402L19.797,18h5.3l5.903,3.342v4.061Z"
          fill="#a62842"
        ></path>
        <path
          d="M1,25.402L12.203,18H6.903L1,21.342v4.061Z"
          fill="#a62842"
        ></path>
        <path
          d="M19.797,14L31,6.598V10.66L25.097,14h-5.3Z"
          fill="#a62842"
        ></path>
        <path
          d="M1,8.96V10.66L18.428,22.28c-.08,.046-.16,.094-.239,.144L1,11.054V12.72L22.27,26.899v-1.742L3.102,12.384l-2.102-1.192v1.54Z"
          fill="#fff"
        ></path>
        <path
          d="M1,23.04v-1.7l17.428-11.62c-.08-.046-.16-.094-.239-.144L1,20.946v-1.666L22.27,5.101v1.742l-19.168,12.773-2.102,1.192v-1.54Z"
          fill="#fff"
        ></path>
        <path
          d="M31,8.96v1.7l-17.428,11.62c.08,.046,.16,.094,.239,.144L31,11.054v1.666L9.73,26.899v-1.742l19.168-12.773,2.102-1.192v1.54Z"
          fill="#fff"
        ></path>
        <path
          d="M31,23.04v-1.7l-17.428-11.62c.08-.046,.16-.094,.239-.144L31,20.946v-1.666L9.73,5.101v1.742l19.168,12.773,2.102,1.192v-1.54Z"
          fill="#fff"
        ></path>
        <path d="M21,18v10h-10V18H1V14H11V4h10V14H31v4H21Z" fill="#fff"></path>
        <path d="M18,18H31v-4H18V4h-4V14H1v4H14V28h4V18Z" fill="#a62842"></path>
        <path
          d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z"
          opacity=".15"
        ></path>
    ...
    // Fallback dictionary map to ensure we catch common aliases
    usa: "united states",
    us: "united states",
    uk: "united kingdom",
  };

  // Check alias logic (e.g., if 'usa', remap to 'united states')
  const resolvedName = typeof flagMap[name] === "string" ? flagMap[name] : name;
  const SvgElement = flagMap[resolvedName];

  if (SvgElement && typeof SvgElement !== "string") {
    return SvgElement;
  }

  // Fallback to Globe for any country we don't have an SVG path for
